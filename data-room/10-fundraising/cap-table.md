...
## Current Cap Table (Pre-Investment)
...
*Final cap table depends on negotiated pre-money valuation and ESOP pool size.*

---

## ESOP (Employee Stock Option Pool)

### Proposed ESOP Structure

| Parameter | Detail |
|---|---|
| **Initial Pool (Pre-Seed)** | 5% of post-money shares (allocated at this round) |
| **Long-Term Target** | 10–15% of post-money shares (expanding through Series A) |
| **Purpose** | Attract and retain top engineering, product, and growth talent |
| **Vesting Schedule** | 4-year vesting, 1-year cliff |
| **Exercise Price** | Fair market value at grant date |
| **Administration** | Board-approved grants |

### Target ESOP Allocations

| Role Level | Equity Range | Example Roles |
|---|---|---|
| **VP / Director** | 0.5–1.5% | VP Engineering, VP Sales |
| **Senior Engineer / Lead** | 0.2–0.5% | Senior Full-Stack, AI/ML Lead |
| **Engineer / Manager** | 0.1–0.2% | Engineers, Product Managers |
| **Individual Contributor** | 0.05–0.1% | Marketing, Operations |
| **Advisors** | 0.10–0.50% | Strategic advisors (4-year vest) |

---

## Cap Table Pro Forma Through Series A

### Projected Ownership Evolution

| Shareholder | Pre-Investment | Post Pre-Seed | Post Series A (est.) |
|---|---|---|---|
| **Founders (Combined)** | 95% | 66–76% | 48–57% |
| **Valu.vc** | 5% | 3.8–4.0% | 3.0–3.5% |
| **Pre-Seed Investors** | — | 15–20% | 12–16% |
| **Series A Investors** | — | — | 15–20% |
| **ESOP Pool** | — | 5–10% | 10–15% |
| **Total** | 100% | 100% | 100% |

### Series A Scenario (2027–2028)

| Parameter | Estimate |
|---|---|
| **Timing** | Q4 2027 – Q2 2028 |
| **Revenue at Series A** | $8–10M ARR |
| **Target Raise** | $20–30M |
| **Expected Pre-Money Valuation** | $100–150M (10–15× ARR) |
...
| **Dividends** | Pro rata (when declared) |
| **Liquidation** | Residual after preferred |
| **Transfer** | Subject to ROFR and co-sale rights |

### Preferred Shares (Pre-Seed Investors)
...
| **Conversion** | Optional — convertible to common at any time |
| **Pro-Rata** | Right to maintain ownership in future rounds |
| **Information Rights** | Monthly financials, quarterly board updates |
| **Board Seat** | 1 seat for lead investor ($2M+ investment) |
